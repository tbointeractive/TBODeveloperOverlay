 ...
 * Therefore it has a Done-Button which dismisses the ViewController when your done. This Button can be temporarily replaced with other functions by the used plugins.
 *
 * ## Usage
